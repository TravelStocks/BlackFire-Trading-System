...
window.LEADER_CYCLE_ARCHIVE = {
  ...
  cycles: [
    ...
    },
    {
      ...
      tradingDays: 8,
      status: "已完成",
      source: { file: "用户本轮节奏总结 + 短线侠连板天梯", sheet: "节奏序列", range: "2026/7/27-2026/8/5" },
      rhythm: "高潮启动 -> 强势弱延续 -> 分化 -> 超强回流 -> 分化 -> 超强回流 -> 分歧 -> 分歧延续",
      oneLine:
        "传智教育从7/27首板一路推进到8/5八板，周期中两次分化后都能被超强回流修复，是“分化后超预期回流”打开高度的典型样本。",
      ...
      phaseLine: [
        ...
        { date: "7/29", title: "分化", tone: "down", note: "题材分化但龙头继续晋级。" },
        { date: "7/30", title: "超强回流", tone: "up", note: "四板回流，完成第一次持续性确认。" },
        { date: "7/31", title: "再分化", tone: "down", note: "高位进入再次考验。" },
        { date: "8/3", title: "超强回流", tone: "up", note: "六板继续打开周期高度。" },
        { date: "8/4", title: "分歧", tone: "warn", note: "七板高位分歧但仍有晋级标记。" },
        { date: "8/5", title: "分歧延续", tone: "down", note: "八板后无晋级标记，转向退潮观察。" }
      ],
      records: [
        ...
        makeCycleRecord("2026/7/29", "周三", "分化", "down", "弱", "3板", "题材进入分化，传智教育仍处在连板链条。", { risk: "分化日看龙头是否能继续承接。" }),
        makeCycleRecord("2026/7/30", "周四", "超强回流", "up", "更强", "4板", "分化后完成超强回流，周期持续性第一次确认。", { risk: "回流后若后排掉队，需要只锚定前排。" }),
        makeCycleRecord("2026/7/31", "周五", "分化", "down", "弱", "5板", "高位再分化，龙头继续晋级。", { risk: "五板后开始进入高度压力区。" }),
        makeCycleRecord("2026/8/3", "周一", "超强回流", "up", "更强", "6板", "节后继续晋级，说明资金仍认可主线高度。", { risk: "第二次回流后留意一致性高潮。" }),
        makeCycleRecord("2026/8/4", "周二", "分歧", "warn", "弱", "7板", "七板仍带晋级标记，高位分歧中继续抱团。", { risk: "高位分歧阶段看中位是否先杀。" }),
        makeCycleRecord("2026/8/5", "周三", "分歧延续", "down", "更弱", "8板", "短线侠记录八板但无后续晋级标记，周期转向风险确认。", { risk: "高度打满后不再按新启动处理。" })
      ]
    },
    {
