    ...
    strengthLongCombos: [
      {
        ...
        conclusion: "这是最标准的六日龙头周期：启动、延续、第一次分化、回流确认、高潮或吹哨、最后大分歧。",
        examples: "立新能源、哈药股份",
        use: "第三日分化不直接判结束，第四日是否强回流才是周期能否升级的核心。第五日若强回流延续但辨识度吹哨，次日进入卖点观察。"
      },
      {
        code: "L2",
        title: "分歧蓄势再启动型",
        ...
        conclusion: "题材先在分歧里蓄势，真正主升从第三个节点启动；前两天不是主升，而是试错和筛选活口。",
        examples: "万向德农",
        use: "前两日只观察活口抗跌，第三日高潮启动才纳入周期；第五日大分化后，若第六日超强回流，确认持续性。"
      },
      {
        code: "L3",
        title: "前置退潮穿越长周期型",
        ...
        conclusion: "旧周期退潮时新龙头穿越，强度不是一路顺推，而是在小分化、小分歧里完成换手和市场地位确认。",
        examples: "华电辽能",
        use: "前置退潮日不追强，只看新龙是否抗跌；中段连续弱强不等于弱，反而是穿越龙补量、换手、接受分歧检验的阶段。"
      },
      {
        code: "L4",
        title: "多次分歧回流爬坡型",
        ...
        conclusion: "题材不是直线高潮，而是每一次分歧后都能重新回流，靠反复压力测试把高度推上去。",
        examples: "传智教育、圣阳股份",
        use: "这种路径的关键不是第一天多强，而是每次弱强之后有没有新的强回流；一旦分歧延续且无法再回流，就进入尾部。"
      },
      {
        code: "L5",
        title: "弱启动换龙高低切型",
        ...
        conclusion: "首日不强但后面连续抬强度，核心在弱分化里换龙，尾部靠内部高低切继续维持题材热度。",
        examples: "百花医药",
        use: "弱启动不能急着定性，第二日和第三日才看是否换龙成功；高位大分歧后不再追老龙，重点看低位补涨是否接力。"
      },
      {
        code: "L6",
        title: "分化后二次回流延展型",
        ...
        conclusion: "启动后很快遭遇大分化，但龙头能带出二次回流，周期会被延展；后段再出现大分歧就是退潮确认。",
        examples: "大唐发电、津药药业",
        use: "第四个节点是分水岭，能强回流就还有主升延展；若只是龙头硬顶而中后排不跟，后面的强势延续要按风险区处理。"
      }
    ]
  },
  cycles: [
