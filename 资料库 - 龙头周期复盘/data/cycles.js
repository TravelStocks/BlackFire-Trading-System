...
window.LEADER_CYCLE_ARCHIVE = {
  ...
  patterns: {
    ...
    strengthSystem: {
      title: "题材强度排列组合",
      summary:
        "题材强度不是只看当天涨停数量，而是看启动后的延续、第一次分化后的修复、龙头是否主动表态，以及中后排是否继续承接。强度由强到弱可分为：更强、强、弱强、弱、更弱。",
      levels: [
        { name: "更强", signal: "超强回流、强势延续、强回流延续", meaning: "龙头继续晋级，板块批量首板/二板扩散，中位无明显负反馈。" },
        { name: "强", signal: "高潮启动、强回流", meaning: "资金完成聚焦，龙头有带动性，后排开始扩散，但仍要等次日确认。" },
        { name: "弱强", signal: "分化但龙头仍晋级", meaning: "板块有分歧，龙头或核心票能抗住，属于验证日，不是退潮日。" },
        { name: "弱", signal: "分化、分歧、随机轮动", meaning: "后排承接不足，资金没有形成一致，只能看龙头能否次日修复。" },
        { name: "更弱", signal: "大分歧、大分化、断板后负反馈", meaning: "龙头失锚或中后排批量炸板/跌停，主升预期明显下降。" }
      ]
    },
    strengthCombos: [
      {
        code: "A",
        title: "强启动强延续型",
        sequence: "高潮启动 - 强 -> 强势延续/连续加强 - 更强",
        conclusion: "启动后第二天就超预期，题材可从轮动升级为可跟踪周期。",
        examples: "立新能源、哈药股份、传智教育、大唐发电、万向德农",
        watch: "看前排是否继续晋级，后排是否还有首板/二板补充；若次日直接熄火，仍按轮动。"
      },
      {
        code: "B",
        title: "分化转强确认型",
        sequence: "高潮启动 - 强 -> 分化/分歧 - 弱 -> 强回流/超强回流 - 更强",
        conclusion: "第一次分化不是卖点本身，分化后的弱转强和板块回流才是周期确认点。",
        examples: "立新能源、哈药股份、大唐发电、圣阳股份、津药药业、万向德农",
        watch: "看龙头弱转强、爆量回封或率先上板，同时板块出现批量反包和低位首板。"
      },
      {
        code: "C",
        title: "前置退潮穿越型",
        sequence: "前置退潮/分歧 - 弱 -> 龙头活口 - 弱强 -> 超强回流 - 更强",
        conclusion: "旧周期退潮时，新龙头先作为活口出现，次日若能与板块超强回流共振，就有穿越概率。",
        examples: "华电辽能、圣阳股份、津药药业、万向德农",
        watch: "前置阶段不能只看当天强弱，要看旧龙负反馈下新龙是否抗跌、换手和继续晋级。"
      },
      {
        code: "D",
        title: "弱启动换龙高低切型",
        sequence: "弱启动 - 弱强 -> 强势弱延续 - 更强 -> 弱分化/龙头切换 - 强",
        conclusion: "第一天不强，但后面不断抬强度，核心在于弱分化中完成换龙或高低切。",
        examples: "百花医药、津药药业、华电辽能后段",
        watch: "看前龙是否温和退场、新龙是否接过身位，低位首板和二板是否继续补充。"
      },
      {
        code: "E",
        title: "多次分歧回流爬坡型",
        sequence: "分化 - 弱强 -> 超强回流 - 更强 -> 再分歧 - 弱强 -> 再强回流 - 强",
        conclusion: "题材不是一口气高潮，而是在多次压力测试里不断修复，容易走出七板以上高度。",
        examples: "传智教育、圣阳股份、华电辽能",
        watch: "每次分歧都要看中位是否先杀；只要龙头不跌停且低位仍补涨，周期仍可延续。"
      },
      {
        code: "F",
        title: "高潮接分歧尾部型",
        sequence: "强势延续/高潮接分化 - 强 -> 分歧延续/大分歧 - 更弱",
        conclusion: "高位强不代表还能买，尾部往往是龙头还在、后排先坏，最后龙头补跌定退潮。",
        examples: "立新能源、百花医药、圣阳股份、大唐发电、津药药业、万向德农",
        watch: "重点盯中位大面、辨识度尾盘跳水、批量炸板、监管红线和次日无法修复。"
      }
    ]
  },
  cycles: [
